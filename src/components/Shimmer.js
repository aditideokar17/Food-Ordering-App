    ...
    return (
      <div className="shimmer-container bg-gray-100 p-4 min-h-screen">
        ...
        <div className="search flex gap-3 mb-6 justify-center items-center">
          <div className="shimmer-search-input h-[50px] w-[500px] bg-gray-300 rounded-md animate-pulse"></div>
          <div className="shimmer-search-btn h-[50px] w-24 bg-gray-300 rounded-md animate-pulse"></div>
        </div>
        ...
        <div className="res-container grid grid-cols-2 md:grid-cols-4 gap-3">
          {[...Array(8)].map((_, index) => (
            <div
              key={index}
              className="shimmer-card h-[200px] w-[300px] bg-gray-300 rounded-lg animate-pulse"
            ></div>
          ))}
        </div>
      </div>
